...
__m256i SIMD_T_func(__m256i R) {
    __m256i mask, R_s0, R_s1, R_s2, R_s3;
    mask = _mm256_setr_epi32(0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff);
    R_s0 = _mm256_srli_epi32(R, 0);
    R_s1 = _mm256_srli_epi32(R, 8);
    R_s2 = _mm256_srli_epi32(R, 16);
    R_s3 = _mm256_srli_epi32(R, 24);
    R_s0 = _mm256_and_si256(R_s0, mask);
    R_s1 = _mm256_and_si256(R_s1, mask);
    R_s2 = _mm256_and_si256(R_s2, mask);
    R_s0 = _mm256_i32gather_epi32((int*)Table0, R_s0, 4);
    R_s1 = _mm256_i32gather_epi32((int*)Table1, R_s1, 4);
    R_s2 = _mm256_i32gather_epi32((int*)Table2, R_s2, 4);
    R_s3 = _mm256_i32gather_epi32((int*)Table3, R_s3, 4);
    R = _mm256_xor_si256(R_s0, R_s1);
    R = _mm256_xor_si256(R, R_s2);
    R = _mm256_xor_si256(R, R_s3);
    return R;
}
